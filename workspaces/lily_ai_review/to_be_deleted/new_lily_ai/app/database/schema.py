...
def create_schema() -> bool:
    ...
    try:
        ...
        CREATE INDEX IF NOT EXISTS idx_papers_topic ON public.papers (topic);
        """
...
def check_schema() -> Dict[str, bool]:
    ...
    try:
        db_client = get_db_client()
        tables = ["subscriptions", "payments", "papers", "settings"]
        result = {}
        ...
        return {table_name: False for table_name in ["subscriptions", "payments", "papers", "settings"]}
